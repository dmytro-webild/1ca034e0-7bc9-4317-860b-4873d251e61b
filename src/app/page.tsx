...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/group-graphic-designers-working-together_1170-1090.jpg",
          imageAlt: "Group of graphic designers working together",
        },
        {
          ...
          imageAlt: "Professional editor uses AI powered software and PC reels in a creative office",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-happy-colleagues-talking_23-2149006918.jpg",
          imageAlt: "Medium shot happy colleagues talking",
        },
      ]}
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        {
          type: "text",
          content: "Creative Souls,",
        },
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/work-desk-with-papers_1134-249.jpg",
          alt: "About R&B",
        },
        {
          type: "text",
          content: "Reliable Results",
        },
      ]}
    />
  </div>
      ...
      features={[
        {
          ...
          description: "Beautiful, high-performing websites designed to convert visitors into customers.",
          imageSrc: "http://img.b2bpic.net/free-photo/ideas-creative-mission-strategy-vision-concept_53876-124143.jpg",
        },
        {
          title: "Social Media Growth",
          description: "Strategic management to make your social platforms look better than ever.",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=nmvvdo",
        },
        {
          title: "Creative Strategy",
          description: "Unique, professional ideas from specialists committed to your success.",
          imageSrc: "http://img.b2bpic.net/free-psd/social-media-logo-design_23-2151299465.jpg",
        },
      ]}
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          ...
          description: "Kind and helpful support.",
          icon: Star,
        },
        {
          id: "m3",
          ...
          description: "Consistently 5-star feedback.",
          icon: ThumbsUp,
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          company: "Startup",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/people-working-together-office_23-2149337246.jpg",
        },
        {
          id: "t5",
          name: "Jane Smith",
          ...
          company: "GrowthCo",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-arrangement-emotions_23-2148860286.jpg",
        },
      ]}
      kpiItems={[
        {
      ...
      faqs={[
        {
          ...
          content: "We have been providing creative services for over 9 years.",
        },
        {
          id: "f2",
          title: "What makes your team different?",
          content: "Our team is built on creative ideas, kindness, and deep expertise.",
        },
        {
          id: "f3",
          title: "Can you help our sales grow?",
          content: "Yes, our social media and web strategies are proven to increase sales.",
        },
      ]}
